  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="game-card" style="background-color: #FFDAB9;">
        ...
        <button style="background-color: #FFB6C1;">Play Quiz</button>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="game-card" style="background-color: #87CEFA;">
        ...
        <h5>Puzzle Game</h5>
        <p class="game-description">Solve puzzles to unlock cool toys!</p>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="testimonial-card">
          <h5>John Doe</h5>
          <p>"My kids love JoyPlay! They learn so much while having fun!"</p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="testimonial-card">
