...
<body>
  ...
  <div class="center-content">
    <div class="images">
      <img src="../images/rabit.png" alt="Dog Image">
    </div>
    <form action="" method="POST">
      ...
      <button type="button" class="skip-btn" onclick="window.location.href='3rd.php';">Skip</button>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($selectedAnimal === 'rabbit') {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Correct!',
            text: 'You selected RABBIT!'
        }).then((result) => {
            if (result.isConfirmed) {
                window.location.href = '3rd.php'; // Replace with your target HTML file
            }
        });
        </script>";
    } else {
