...
<body>
  ...
  <div class="center-content">
    <div class="images">
      <img src="../images/mon.png" alt="PIZZA Image">
    </div>
    <form action="" method="POST">
      ...
      <button type="button" class="skip-btn" onclick="window.location.href='11th.php';">Skip</button>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($selectedAnimal === 'monkey') {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Correct!',
            text: 'You selected MONKEY!'
        }).then((result) => {
            if (result.isConfirmed) {
                window.location.href = '11th.php'; // Replace with your target HTML file
            }
        });
        </script>";
    } else {
