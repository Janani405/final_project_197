...
<body>
  ...
  <div class="center-content">
    <div class="images">
      <img src="../images/elephant.webp" alt="Elephant Image">
    </div>
    <form action="" method="POST">
      ...
      <button type="button" class="skip-btn" onclick="window.location.href='4th.php';">Skip</button>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($selectedAnimal === 'elephant') {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Correct!',
            text: 'You selected ELEPHANT!'
        }).then((result) => {
            if (result.isConfirmed) {
                window.location.href = '4th.php'; // Replace with your target HTML file
            }
        });
        </script>";
    } else {
