...
<!-- Your existing HTML content for the page -->
...
<body>
  ...
  <div class="center-content">
    ...
    <form action="" method="POST">
        ...
        <button type="button" class="skip-btn" onclick="window.location.href='2nd.php';">Skip</button>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($selectedAnimal === 'dog') {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Correct!',
            text: 'You selected DOG!'
        }).then((result) => {
            if (result.isConfirmed) {
                window.location.href = '2nd.php'; // Replace with your target HTML file
            }
        });
        </script>";
    } else {
