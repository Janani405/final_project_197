...
<body>
  ...
  <div class="center-content">
    <div class="images">
      <img src="../images/drink.png" alt="PIZZA Image">
    </div>
    <form action="" method="POST">
      <h3>Who am I:</h3>
      <div class="radio-group">
        <input type="radio" id="drink" name="animal" value="drink">
        <label for="drink">DRINK</label>
        <input type="radio" id="pizza" name="animal" value="pizza">
        <label for="pizza">PIZZA</label>
        <input type="radio" id="tree" name="animal" value="tree">
        <label for="tree">TREE</label>
      </div>
      <button type="submit" class="submit-btn">Submit</button>
      <button type="button" class="skip-btn" onclick="window.location.href='10th.php';">Skip</button>
    ...
    if ($selectedAnimal === 'drink') {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '10th.php'; // Replace with your target HTML file
            }
        });
        </script>";
    } else {
