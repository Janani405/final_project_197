...
<body>
  ...
  <div class="center-content">
    <div class="images">
      <img src="../images/ice.png" alt="Elephant Image">
    </div>
    <form action="" method="POST">
      ...
      <button type="button" class="skip-btn" onclick="window.location.href='5th.php';">Skip</button>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($selectedAnimal === 'ice') {
        echo "
        <script>
        Swal.fire({
            icon: 'success',
            title: 'Correct!',
            text: 'You selected ICE-CREAM!'
        }).then((result) => {
            if (result.isConfirmed) {
                window.location.href = '5th.php'; // Replace with your target HTML file
            }
        });
        </script>";
    } else {
