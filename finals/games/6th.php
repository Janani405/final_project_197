...
<body>
  ...
  <div class="center-content">
    ...
    <form action="" method="POST">
      ...
      <button type="button" class="skip-btn" onclick="window.location.href='7th.php';">Skip</button>
    ...
    if ($selectedAnimal === 'pizza') {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '7th.php'; // Replace with your target HTML file
            }
        });
        </script>";
    } else {
