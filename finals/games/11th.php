...
<body>
  ...
  <div class="center-content">
    <div class="images">
      <img src="../images/dolphin-removebg-preview.png" alt="PIZZA Image">
    </div>
    <form action="" method="POST">
      ...
      <button type="button" class="skip-btn" onclick="window.location.href='12th.php';">Skip</button>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($selectedAnimal === 'dolphin') {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Correct!',
            text: 'You selected DOLPHIN!'
        }).then((result) => {
            if (result.isConfirmed) {
                window.location.href = '12th.php'; // Replace with your target HTML file
            }
        });
        </script>";
    } else {
