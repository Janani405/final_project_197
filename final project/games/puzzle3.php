...
<body>
  ...
  <div class="center-content">
    <div class="images">
      <img src="../images/puzzle3.png" alt="PUZZLE Image" style="width: 450px;">
    </div>
    <form action="" method="POST">
      ...
      <button type="button" class="skip-btn" onclick="window.location.href='puzzle4.php';">Skip</button>
    </form>
  </div>
</body>
</html>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $correctAnswers = ['horse', 'wolf','goat'];
    ...
    if (!array_diff($correctAnswers, $selectedAnimals) && !array_diff($selectedAnimals, $correctAnswers)) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = 'puzzle4.php'; // Replace with your target HTML file
            }
        });
        </script>";
    } else {
