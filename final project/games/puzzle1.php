...
<body>
  ...
  <div class="center-content">
    <div class="images">
    <img src="../images/puzzle1-01.png" alt="PIZZA Image" style="width: 80%; max-width: 700px;">
    ...
    <form action="" method="POST">
      ...
      <div class="checkbox-group">
        ...
        <input type="checkbox" id="car" name="animal[]" value="car">
        <label for="car">CAR</label>
        <input type="checkbox" id="rabbit" name="animal[]" value="rabbit">
        <label for="rabbit">RABBIT</label>
      </div>
      <button type="submit" class="submit-btn">Submit</button>
      <button type="button" class="skip-btn" onclick="window.location.href='puzzle2.php';">Skip</button>
    </form>
  </div>
</body>
</html>
    ...
    if (!array_diff($correctAnswers, $selectedAnimals) && !array_diff($selectedAnimals, $correctAnswers)) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = 'puzzle2.php'; // Replace with your target HTML file
            }
        });
        </script>";
    } else {
